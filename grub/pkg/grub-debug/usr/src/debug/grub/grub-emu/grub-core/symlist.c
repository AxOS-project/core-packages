...
#include <../include/grub/compiler-rt-emu.h>
...
#include <../include/grub/datetime.h>
#include <../include/grub/emu/misc.h>
#include <../include/grub/emu/net.h>
#include <../include/grub/emu/hostdisk.h>
#include <../include/grub/emu/hostfile.h>
#include <../include/grub/extcmd.h>
#include <../include/grub/emu/exec.h>
#include <../include/grub/sdl.h>
...
grub_register_exported_symbols (void)
{
  ...
  static struct symtab tab[] =
    {
      {"SDL_CreateRGBSurface", SDL_CreateRGBSurface, 1},
      {"SDL_CreateRenderer", SDL_CreateRenderer, 1},
      {"SDL_CreateTexture", SDL_CreateTexture, 1},
      {"SDL_CreateWindow", SDL_CreateWindow, 1},
      {"SDL_GetError", SDL_GetError, 1},
      {"SDL_GetWindowSurface", SDL_GetWindowSurface, 1},
      {"SDL_Init", SDL_Init, 1},
      {"SDL_Quit", SDL_Quit, 1},
      {"SDL_RenderClear", SDL_RenderClear, 1},
      {"SDL_RenderCopy", SDL_RenderCopy, 1},
      {"SDL_RenderPresent", SDL_RenderPresent, 1},
      {"SDL_SetPaletteColors", SDL_SetPaletteColors, 1},
      {"SDL_UpdateTexture", SDL_UpdateTexture, 1},
      {"__bswapdi2", __bswapdi2, 1},
      {"__bswapsi2", __bswapsi2, 1},
      {"__bzero", __bzero, 1},
      {"__clzdi2", __clzdi2, 1},
      {"__ctzdi2", __ctzdi2, 1},
      {"__deregister_frame_info", __deregister_frame_info, 1},
      {"__register_frame_info", __register_frame_info, 1},
      {"grub_abort", grub_abort, 1},
      {"grub_arg_show_help", grub_arg_show_help, 1},
      {"grub_boot_time_head", (void *) &grub_boot_time_head, 0},
      ...
      {"grub_disk_cache_get_performance", grub_disk_cache_get_performance, 1},
      ...
      {"grub_emunet_close", grub_emunet_close, 1},
      {"grub_emunet_create", grub_emunet_create, 1},
      {"grub_emunet_receive", grub_emunet_receive, 1},
      {"grub_emunet_send", grub_emunet_send, 1},
      ...
      {"grub_get_datetime", grub_get_datetime, 1},
      ...
      {"grub_no_modules", (void *) &grub_no_modules, 0},
      ...
      {"grub_real_boot_time", grub_real_boot_time, 1},
      ...
      {"grub_util_error", grub_util_error, 1},
      {"grub_util_exec", grub_util_exec, 1},
      {"grub_util_fd_close", grub_util_fd_close, 1},
      {"grub_util_fd_open", grub_util_fd_open, 1},
      {"grub_util_fd_read", grub_util_fd_read, 1},
      {"grub_util_fd_strerror", grub_util_fd_strerror, 1},
      {"grub_util_fd_write", grub_util_fd_write, 1},
      {"grub_util_get_cpu_time_ms", grub_util_get_cpu_time_ms, 1},
      {"grub_util_get_kexecute", grub_util_get_kexecute, 1},
      {"grub_util_info", grub_util_info, 1},
      {"grub_util_is_regular", grub_util_is_regular, 1},
      {"grub_util_set_kexecute", grub_util_set_kexecute, 1},
      {"grub_util_warn", grub_util_warn, 1},
