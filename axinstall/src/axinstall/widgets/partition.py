...
from axinstall.manualpartitioning import filesystems, mountpoints
from axinstall.classes.partition import Partition


@Gtk.Template(resource_path="/com/axos-project/axinstall/widgets/partition.ui")
class PartitionEntry(Adw.ActionRow):
    ...
    def on_filesystem_select(self, widget):
        ...
        print("select " + self.partition.generate_axinstall_entry())
