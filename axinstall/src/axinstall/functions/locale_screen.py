...
#
# Copyright 2022 Ardox <ardox@axos-project>
...
from axinstall.widgets.locale import LocaleEntry
from axinstall.widgets.selected_locale import SelectedLocale
from axinstall.utils.gtk_helpers import set_list_text



@Gtk.Template(resource_path="/com/axos-project/axinstall/pages/locale/locale_screen.ui")
class LocaleScreen(AxinstallScreen, Adw.Bin):
    ...
    def __init__(self, window, locations, set_valid, application, **kwargs):
        ...
        builder = Gtk.Builder.new_from_resource(
            "/com/axos-project/axinstall/pages/locale/locale_dialog.ui"
        )
