...
@Gtk.Template(resource_path="/com/axos-project/axinstall/pages/finished_screen.ui")
class FinishedScreen(AxinstallScreen, Adw.Bin):
    ...
    def output(self, widget):
        with open("/tmp/axinstall-output.txt", "r") as f:
            output = f.read()
        LogWindow(window=self.window, title="Axinstall log view", content=output).present()
